...
| Block 4: Raw Socket vs eBPF | Reproduce Figure 10: UDP packet processing throughput for raw socket and optionally eBPF/XDP | Implemented ARM64 baseline UDP loopback sender-side PPS benchmark for 128B, 512B, and 1472B packets; UB/eBPF/XDP comparison pending x86_64 artifact results | results/raw/paper_raw_socket_baseline.csv | Baseline done |